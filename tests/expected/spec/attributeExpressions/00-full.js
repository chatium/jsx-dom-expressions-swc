...
const template27 = (() => {
  const _el$34 = _tmpl$13();
  _$spread(_el$34, _$mergeProps(first, {
    "middle": middle
  }, second), false, true);
  return _el$34;
})();
...
const template31 = (() => {
  ...
  _$effect(() => getStore.itemProperties.color != null ? _el$42.style.setProperty("background-color", getStore.itemProperties.color) : _el$42.style.removeProperty("background-color"));
  return _el$42;
})();
const template32 = (() => {
  const _el$43 = _tmpl$4();
