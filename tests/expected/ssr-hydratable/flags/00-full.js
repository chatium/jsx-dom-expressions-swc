...
const _tmpl$ = ["<div", "><h1>Hello</h1><!--#-->", "<!--/--><!--#-->", "<!--/--><span>More Text</span></div>"],
  _tmpl$2 = ["<div", "></div>"],
  _tmpl$3 = ["<span", "></span>"];
const template = _$ssr(_tmpl$, _$ssrHydrationKey(), _$escape(_$createComponent(Component, {})), _$escape(state.interpolation));
