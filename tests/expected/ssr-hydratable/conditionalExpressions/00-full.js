...
const template5 = _$ssr(_tmpl$, _$ssrHydrationKey(), state.dynamic ? _$escape(good()) : _$escape(bad));
...
const template8 = _$ssr(_tmpl$, _$ssrHydrationKey(), state.dynamic && state.something && _$escape(good()));
const template9 = _$ssr(_tmpl$, _$ssrHydrationKey(), state.dynamic && _$escape(good()) || _$escape(bad));
const template10 = _$ssr(_tmpl$, _$ssrHydrationKey(), state.a ? "a" : state.b ? "b" : state.c ? "c" : "fallback");
...
const template19 = _$ssr(_tmpl$, _$ssrHydrationKey(), state.dynamic ? _$createComponent(Comp, {}) : _$createComponent(Comp, {}));
const template20 = _$ssr(_tmpl$, _$ssrHydrationKey(), state.dynamic ? _$escape(_$createComponent(Comp, {})) : _$escape(_$createComponent(Comp, {})));
...
const template28 = _$ssr(_tmpl$, _$ssrHydrationKey(), _$escape(state.dynamic) ?? _$escape(_$createComponent(Comp, {})));
const template29 = _$ssr(_tmpl$, _$ssrHydrationKey(), (thing() && _$escape(thing1())) ?? _$escape(thing2()) ?? _$escape(thing3()));
const template30 = _$ssr(_tmpl$, _$ssrHydrationKey(), _$escape(thing()) || _$escape(thing1()) || _$escape(thing2()));
