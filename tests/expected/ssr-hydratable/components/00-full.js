...
const template = props => {
  ...
  return _$ssr(_tmpl$4, _$ssrHydrationKey(), _$escape(_$createComponent(Child, _$mergeProps({
    name: "John"
  }, props, {
...
const template3 = _$createComponent(Child, {
  get children() {
    return [_$ssr(_tmpl$5, _$ssrHydrationKey()), _$ssr(_tmpl$5, _$ssrHydrationKey()), _$ssr(_tmpl$5, _$ssrHydrationKey()), "After"];
  }
});
const [s, set] = createSignal();
...
const template10 = _$ssr(_tmpl$6, _$ssrHydrationKey(), _$escape(_$createComponent(Link, {
  children: "new"
...
const template11 = _$ssr(_tmpl$7, _$ssrHydrationKey(), _$escape(_$createComponent(Link, {
  children: "new"
})), _$escape(_$createComponent(Link, {
  children: "comments"
})), _$escape(_$createComponent(Link, {
...
const template12 = _$ssr(_tmpl$8, _$ssrHydrationKey(), _$escape(_$createComponent(Link, {
  children: "comments"
})), _$escape(_$createComponent(Link, {
  children: "show"
})));
...
const Template17 = _$createComponent(Pre, {
  get children() {
    return [_$ssr(_tmpl$9, _$ssrHydrationKey()), " ", _$ssr(_tmpl$0, _$ssrHydrationKey()), " ", _$ssr(_tmpl$1, _$ssrHydrationKey())];
  }
});
