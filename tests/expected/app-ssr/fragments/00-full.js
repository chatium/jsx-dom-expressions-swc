...
const multiDynamic = [_$ssr(_tmpl$3, _$ssrAttribute("id", _$escape(state.first, true), false)), state.inserted, _$ssr(_tmpl$4, _$ssrAttribute("id", _$escape(state.last, true), false)), "After"];
