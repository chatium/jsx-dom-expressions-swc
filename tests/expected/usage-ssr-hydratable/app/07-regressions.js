...
const optionalMember = _$ssr(_tmpl$, _$ssrHydrationKey(), isEnabled(ctx) && _$escape(store.workspace?.path));
const optionalCall = _$ssr(_tmpl$, _$ssrHydrationKey(), isEnabled(ctx) && _$escape(store.load?.()));
...
const wrapped = _$ssr(_tmpl$, _$ssrHydrationKey(), _$escape(_$createComponent(Child, {
  get folderPath() {
...
const hoisted = _$ssr(_tmpl$2, _$ssrHydrationKey(), LATER_STYLES);
const inOrder = _$ssr(_tmpl$2, _$ssrHydrationKey(), EARLIER_STYLES);
const LATER_STYLES = `.a { color: red }`;

// A template literal folds when its substitutions do, so this becomes a plain setProperty.
const ROW_HEIGHT_PX = 72;
const templated = _$ssr(_tmpl$3, _$ssrHydrationKey(), "height:" + `${_$escape(ROW_HEIGHT_PX, true)}px`);
...
const looseEquality = _$ssr(_tmpl$5, _$ssrHydrationKey(), `base ${"dark" == "dark" ? "dark" : ""} ${1 < 2 ? "lt" : ""}`);
...
const foldsOnce = _$ssr(_tmpl$3, _$ssrHydrationKey(), _$ssrStyle(onceUsed));
const staysDynamicA = _$ssr(_tmpl$3, _$ssrHydrationKey(), _$ssrStyle(twiceUsed));
const staysDynamicB = _$ssr(_tmpl$3, _$ssrHydrationKey(), _$ssrStyle(twiceUsed));
...
const unmatchedRef = _$ssr(_tmpl$6, _$ssrHydrationKey());
...
const literalMethods = _$ssr(_tmpl$7, _$ssrHydrationKey());
const casing = _$ssr(_tmpl$8, _$ssrHydrationKey());
...
const ssrLogicalAttr = _$ssr(_tmpl$9, _$ssrHydrationKey() + _$ssrAttribute("class", _$escape(props.class, true) || "w-4 h-4", false));
...
const numericAttrs = _$ssr(_tmpl$0, _$ssrHydrationKey(), _$ssrAttribute("tabindex", -1, false));
...
const ssrComputedStyle = _$ssr(_tmpl$3, _$ssrHydrationKey(), "color:" + _$escape(c, true) + (";cssVar:" + _$escape(v, true)) + (";--x:" + _$escape(w, true)) + (";undefined:" + _$escape(z, true)));
...
const wontEscape = _$ssr(_tmpl$, _$ssrHydrationKey(), cond ? _tmpl$10[0] + _$ssrHydrationKey() + _tmpl$10[1] : _$escape(null));
