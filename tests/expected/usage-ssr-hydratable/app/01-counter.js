...
export const Page = createComponent(ctx => {
  ...
  return _$ssr(_tmpl$2, _$ssrHydrationKey(), `page ${items().length === 0 ? "empty" : ""}`, _$escape(_$createComponent(Widget, {})), _$escape(ctx.t('Count')), _$escape(count()), _$escape(_$createComponent(Show, {
    get when() {
      return count() > 0;
    },
    get fallback() {
    ...
    get children() {
      return _$ssr(_tmpl$, _$ssrHydrationKey(), _$escape(_$createComponent(For, {
        ...
        children: item => _$ssr(_tmpl$4, _$ssrHydrationKey() + _$ssrAttribute("title", _$escape(item.name, true), false), _$escape(item.name))
      })));
    }
