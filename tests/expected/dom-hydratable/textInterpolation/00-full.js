...
/* prettier-ignore */
const multiExpr = (() => {
  const _el$10 = _$getNextElement(_tmpl$6),
...
const multiExprSpaced = (() => {
  const _el$16 = _$getNextElement(_tmpl$7),
...
const multiExprTogether = (() => {
  const _el$24 = _$getNextElement(_tmpl$8),
...
const newLineLiteral = (() => {
  const _el$38 = _$getNextElement(_tmpl$12),
...
const trailingSpace = (() => {
  const _el$42 = _$getNextElement(_tmpl$13);
...
const leadingSpaceElement = (() => {
  const _el$43 = _$getNextElement(_tmpl$14),
...
const trailingSpaceElement = (() => {
  const _el$47 = _$getNextElement(_tmpl$15),
...
const lastElementExpression = (() => {
  const _el$52 = _$getNextElement(_tmpl$17),
