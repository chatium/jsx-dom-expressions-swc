...
const template = props => {
  ...
  return (() => {
    ...
    _$insert(_el$6, _$createComponent(Child, _$mergeProps({
      name: "John"
    }, props, {
      ref(r$) {
...
const template3 = _$createComponent(Child, {
  get children() {
    return [_$getNextElement(_tmpl$2), _$getNextElement(_tmpl$2), _$getNextElement(_tmpl$2), "After"];
  }
});
const [s, set] = createSignal();
...
const template10 = (() => {
  const _el$18 = _$getNextElement(_tmpl$5),
  ...
  _$insert(_el$18, _$createComponent(Link, {
    children: "new"
  }), _el$25, _co$5);
  _$insert(_el$18, _$createComponent(Link, {
    children: "comments"
...
const template11 = (() => {
  const _el$36 = _$getNextElement(_tmpl$6),
  ...
  _$insert(_el$36, _$createComponent(Link, {
    children: "new"
  }), _el$41, _co$1);
  _$insert(_el$36, _$createComponent(Link, {
    children: "comments"
...
const template12 = (() => {
  const _el$52 = _$getNextElement(_tmpl$7),
  ...
  _$insert(_el$52, _$createComponent(Link, {
    children: "comments"
  }), _el$59, _co$15);
  _$insert(_el$52, _$createComponent(Link, {
    children: "show"
